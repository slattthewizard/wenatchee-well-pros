---
title: "How to Adjust a Well Pump Pressure Switch (30/50, 40/60, and When to Leave It Alone)"
navTitle: "How to Adjust a Well Pump"
metaTitle: "Well Pump Pressure Switch Adjustment: 30/50 or 40/60?"
metaDescription: "A well pump pressure switch adjustment takes ten minutes and two nuts. How to do it safely, what 30/50 and 40/60 mean, and when raising pressure backfires."
primaryKeyword: "well pump pressure switch adjustment"
secondaryKeywords: "how to adjust a well pressure switch, 30/50 vs 40/60 pressure switch, pressure switch cut-in cut-out settings, increase well water pressure, adjust pressure switch nuts"
publishedDate: "2026-09-09"
tag: "Pressure Tanks"
subtitle: "The shower goes weak the second the washing machine starts filling. You looked it up, and half the internet says to go out to the pump house and crank the big nut on the pressure switch."
canonical: "https://wenatcheewellpros.com/blog/well-pump-pressure-switch-adjustment/"
faq:
  - question: "Which nut raises the pressure on a well pressure switch?"
    answer: "The larger nut on the taller stud, with the heavy spring, is the range nut. Turning it clockwise raises the cut-in and cut-out together, roughly 2 to 3 psi per full turn depending on the switch. The small nut is the differential and only raises the cut-out. Leave that one alone unless you know why you are moving it."
  - question: "Can I go from 30/50 to 40/60 myself?"
    answer: "On a healthy system with reasonably modern plumbing, yes, and it is one of the more satisfying half-hour jobs on a well. Set the tank precharge to 38 psi as part of the change, or you will trade pressure for short cycling. If the pump runs longer than before and struggles to reach 60, put it back to 30/50 and have the pump's capacity checked."
  - question: "Why did adjusting my pressure switch not change anything?"
    answer: "Usually because the switch was never the limit. A waterlogged pressure tank, a clogged sensing tube, a partly closed valve, a plugged filter, or a pump that is already at its ceiling will all hold your pressure down regardless of the setting. Check the tank precharge first, then look at the switch itself."
  - question: "What does it cost to have you set it correctly?"
    answer: "A diagnostic visit runs $150 to $250 and gets applied toward the repair if you hire us. That covers checking the switch, the tank precharge, and what your pump can actually deliver. If the switch needs replacing rather than adjusting, that is $150 to $350. Estimates are free."
---
The shower goes weak the second the washing machine starts filling. You looked it up, and half the internet says to go out to the pump house and crank the big nut on the pressure switch. Sometimes that is exactly the right move. Sometimes it turns a $200 service call into a $2,800 pump replacement.
...
If air comes out of that valve, that is a normal reading. If **water** comes out, the bladder is torn and no adjustment will fix your pressure. That tank is done. Here are [the other signs of a waterlogged tank](/blog/pressure-tank-waterlogged/), and [what a replacement runs](/pressure-tank-replacement-wenatchee/).
...
| Setting | Tank precharge | Fits | Watch out for |
|---|---|---|---|
| 20/40 | 18 psi | Older cabins, galvanized plumbing, low-yield wells | Weak upstairs fixtures, poor shower flow |
| 30/50 | 28 psi | Single-story homes, shallow jet pump systems, older pipe | Pressure drops when two fixtures run at once |
| 40/60 | 38 psi | The workhorse setting for most two-bath homes here | Needs a pump that can comfortably make 60 psi |
| 50/70 | 48 psi | Long uphill runs, second-story fixtures, some booster setups | Hard on old joints, and many pumps cannot hold it |
...
**The real fault is somewhere else.** A clogged sensing tube, burned contacts, a failing check valve, a plugged sediment filter, and a waterlogged tank all look like low pressure from the kitchen sink. Adjusting the switch just hides them for a few weeks. Our guide to [common pressure switch problems](/blog/pressure-switch-problems/) walks through how to tell them apart, and [low water pressure on a well](/blog/low-water-pressure-well/) covers the causes that have nothing to do with the switch.
...
For background on private well systems and what owners are responsible for, the EPA's [private drinking water wells](https://www.epa.gov/privatewells) pages are a decent plain-language starting point, and the Washington State Department of Ecology publishes the state's [water well construction and licensing rules](https://ecology.wa.gov/water-shorelines/water-supply/wells).

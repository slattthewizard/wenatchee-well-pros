...
Between those two, results vary with how the specific formation is jointed. This is why the well log matters so much, and why an honest contractor reads your log and asks what the driller recorded before quoting anything. If your log is missing, [how deep wells run in the Wenatchee area](/blog/how-deep-are-wells-wenatchee/) gives a sense of what is typical locally, but there is no substitute for the record of your own bore.
...
Before you get there, rule out the cheaper explanations, because a great many low water complaints are not yield problems at all. A tired pump, a failing check valve or a pump set too high produces the same symptoms for a fraction of the cost, and [signs your well pump is failing](/blog/signs-well-pump-failing/) sorts those out. If the water arrives but arrives weakly, that is a pressure issue rather than a supply issue, covered in [low water pressure on a well](/blog/low-water-pressure-well/). And if the well draws down and recovers slowly, [a well yield test](/blog/well-yield-test/) is what quantifies the actual problem, while [a well running dry](/blog/well-running-dry/) explains the difference between an empty well and a system that cannot keep up.

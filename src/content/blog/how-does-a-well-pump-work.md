---
title: "How Does a Well Pump Work? A Plain-English Guide"
navTitle: "How Does a Well Pump Work? A"
metaTitle: "How Does a Well Pump Work? A Plain-English Guide (2026)"
metaDescription: "How does a well pump work? A Wenatchee well tech explains submersible and jet pumps, pressure tanks, and switches in plain English, plus what fails first."
primaryKeyword: "how does a well pump work"
secondaryKeywords: "how a well pump works, submersible well pump basics, how a pressure tank works, well water system explained, well pump cycle"
publishedDate: "2026-06-10"
tag: "Well Care"
subtitle: "Right now, there's a machine the size of a baseball bat hanging 300 feet underground on your property, and your morning shower depends entirely on it."
canonical: "https://wenatcheewellpros.com/blog/how-does-a-well-pump-work/"
faq:
  - question: "How does a well pump know when to turn on?"
    answer: "It doesn't, exactly. The pressure switch does the thinking. When you use water, pressure in the system drops, and once it falls to the cut-in setting, usually 30 or 40 psi, the switch closes and powers the pump. When the pressure tank refills to the cut-out setting, the switch opens and the pump stops."
  - question: "How long does a well pump run each time it turns on?"
    answer: "With a healthy pressure tank, a typical cycle runs one to three minutes. Long irrigation draws can keep it running continuously for hours, which is fine for a properly sized submersible. What's not fine is rapid on-off cycling every few seconds, which usually means a tank or switch problem."
  - question: "Does a well pump run all the time?"
    answer: "No. A healthy system runs only when pressure drops, then shuts off once the tank is full. If yours never seems to stop, you've likely got a leak, a stuck pressure switch, or a well struggling to deliver enough water, and it's worth getting checked before the motor burns out."
  - question: "How much electricity does a well pump use?"
    answer: "A typical half to one horsepower residential pump uses roughly 1 to 2 kWh per hour of actual run time, and most households only run the pump one to two hours a day total. That works out to about $5 to $15 a month for most homes around Wenatchee. A short-cycling or constantly running pump can triple that, so a jumping power bill is itself a diagnostic clue."
---
...
**1. The well itself.** A drilled hole, usually 6 inches across, lined with steel or PVC casing. Around Wenatchee, most residential wells run 100 to 500 feet deep depending on whether you're in the valley or up on a bench. We covered local depths in our guide to [how deep wells go in the Wenatchee area](/blog/how-deep-are-wells-wenatchee/).
...
If your water is doing something weird right now and you'd rather skip the theory, give us a ring at [(509) 300-5151](tel:+15093005151). We answer 24/7 and we'll tell you over the phone whether it sounds minor or urgent.
...
The U.S. Geological Survey has a good plain-language overview of [how groundwater wells work](https://www.usgs.gov/special-topics/water-science-school/science/groundwater-wells) if you want the geology side of the story.
...
If you're weighing the two for a replacement, our full [submersible vs jet pump comparison](/blog/submersible-vs-jet-pump/) goes deeper on which makes sense for your well depth and budget.
...
When the bladder fails, the tank gets waterlogged and the pump starts rapid-fire cycling, on for a few seconds, off for a few seconds. You can read more about catching that early in our posts on [waterlogged pressure tanks](/blog/pressure-tank-waterlogged/) and pump short cycling.

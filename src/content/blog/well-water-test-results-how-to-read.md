---
title: "How to Read Your Well Water Test Results, Line by Line"
navTitle: "How to Read Your Well Water"
metaTitle: "How to Read Your Well Water Test Results (Line by Line)"
metaDescription: "Well water test results explained line by line: mg/L vs ppm, CFU/100mL, MCL vs secondary standards, and what nitrate, arsenic, and bacteria numbers mean."
primaryKeyword: "well water test results"
secondaryKeywords: "how to read well water test results, mg/L vs ppm well water, MCL vs secondary standards, CFU/100mL well water test, well water lab report explained"
publishedDate: "2026-08-10"
tag: "Water Quality"
subtitle: "You just opened the PDF from the lab, and it's a wall of abbreviations, decimal points, and columns with headers like \"MCL\" and \"CFU/100mL\" that mean nothing to you."
canonical: "https://wenatcheewellpros.com/blog/well-water-test-results-how-to-read/"
faq:
  - question: "Is a well water test result in mg/L the same as ppm?"
    answer: "For water, yes, they're functionally identical, since a liter of water weighs almost exactly one kilogram. A nitrate result of 8 mg/L and 8 ppm describe the same concentration. The units that do matter to double-check are ppb versus ppm, since ppb is a thousand times smaller and shows up on arsenic and lead results."
  - question: "What's the difference between an MCL and a secondary standard on my report?"
...
We'll cover the units labs use, the difference between a legal limit and a nuisance guideline, and what the most common results, bacteria, nitrates, arsenic, iron, and the rest, actually tell you about your water. If a number on your report doesn't add up or you just want someone to talk you through it, [reach out for a free estimate](/#contact) and we'll go through the report with you, no charge for the conversation.
...
That distinction is exactly why two people can look at a lab report with several "high" flags and need completely different responses. Someone with high iron and hardness needs a filtration conversation. Someone with elevated nitrate or arsenic needs to stop drinking the water until it's addressed. The EPA keeps the full official list of primary and secondary standards at [epa.gov](https://www.epa.gov/ground-water-and-drinking-water/national-primary-drinking-water-regulations), and it's worth five minutes to see exactly where your results land.
...
**Roy in Moses Lake** had six years of clean tests before a wet spring changed that. His April sample came back "Present" for total coliform, no E. coli, after snowmelt pooled around a wellhead sitting a few inches below grade. A well cap reseal and shock chlorination ran him $265, and his retest ten days later came back clean. If your bacteria result comes back positive, our guide to [shock chlorinating a well](/blog/well-chlorination-shock/) walks through what that process actually involves, and our full [well water testing](/blog/well-water-testing-wenatchee/) article covers how often to retest going forward.
...
| Result | Reported As | Standard Type | Limit | What It Means |
|---|---|---|---|---|
| Total coliform | Present/Absent | Primary (MCL) | 0 (absent) | Any detection means retest and find the entry point |
| E. coli | Present/Absent | Primary (MCL) | 0 (absent) | Any detection means stop drinking until resolved |
| Nitrate (as N) | mg/L | Primary (MCL) | 10 mg/L | Above this is a real health risk, especially for infants |
| Arsenic | ppb (µg/L) | Primary (MCL) | 10 ppb | Long-term exposure concern above this level |
| Lead | ppb (µg/L) | Action level | 15 ppb | Corrosion issue, usually from plumbing, not the aquifer |
| Iron | mg/L | Secondary (SMCL) | 0.3 mg/L | Staining and taste, not a health limit |
| Manganese | mg/L | Secondary (SMCL) | 0.05 mg/L | Staining; separate infant health advisory at higher levels |
| Hardness | mg/L or GPG | No formal standard | 180+ mg/L is hard | Scale buildup, not a health concern |
| pH | Standard units | Secondary (SMCL) | 6.5-8.5 | Outside range can corrode pipes or taste off |
| TDS | mg/L | Secondary (SMCL) | 500 mg/L | Taste and clarity threshold, not health-based |
...
**If it's iron, manganese, hardness, or pH,** there's no health emergency, but there is an equipment cost hiding downstream. Iron-heavy, acidic, or very hard water eats through pressure switches, check valves, and tank fittings years before they should fail. If your [pressure tank](/pressure-tank-replacement-wenatchee/) is already short cycling or waterlogged on top of a water chemistry issue, that's worth addressing together rather than one at a time.

Sediment or grit showing up in a sample is its own category. It's not usually a chemistry problem at all, more often a sign of a worn pump screen or a failing pump pulling material up from the bottom of the well. That grit then damages the pump itself, so if your water turned gritty out of nowhere, get the [well pump inspected](/well-pump-repair-wenatchee/) before the abrasion shortens its life further.

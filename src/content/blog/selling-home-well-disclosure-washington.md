---
title: "Selling a Home With a Well in Washington: What You Must Test and Disclose"
navTitle: "Selling a Home With a Well in"
metaTitle: "Selling a Home With a Well in Washington: Seller's Guide"
metaDescription: "Selling a home with a well in Washington? Learn what Form 17 requires you to disclose and what FHA, VA, and USDA lenders test for before your buyer can close."
primaryKeyword: "selling a home with a well in washington"
secondaryKeywords: "washington form 17 well disclosure, fha well water test requirements, va well water test requirements, well inspection before selling a house, selling a house with a well washington"
publishedDate: "2026-08-12"
tag: "Water Quality"
subtitle: "Your buyer's lender is going to test your well whether you volunteer anything or not, and whatever that test turns up becomes your problem the moment escrow opens."
canonical: "https://wenatcheewellpros.com/blog/selling-home-well-disclosure-washington/"
faq:
  - question: "Is Form 17 required if I'm selling a home with a well in Washington?"
...
- Whether there's a water right permit, certificate, or claim tied to the well, and whether any portion of that right has gone unused for five or more consecutive years (most rural properties here run on a [permit-exempt well](/blog/water-rights-well-washington/), and the [Washington Department of Ecology's groundwater permit exemption page](https://ecology.wa.gov/water-shorelines/water-supply/water-rights/groundwater-permit-exemption) explains what that status does and doesn't cover)
...
The lender's water test isn't optional and isn't something you can substitute your own results for, even if you tested last year. [Our well water testing service](/blog/well-water-testing-wenatchee/) can get you a current panel fast, and knowing your numbers before a buyer's underwriter does means no surprises during their contingency window.
...
A full water panel runs $150 to $400 depending on what you're testing for. That's a small number next to the cost of a financing delay or a renegotiated price. The [Washington Department of Health recommends annual testing](https://doh.wa.gov/community-and-environment/drinking-water/contaminants/testing-your-water) for coliform bacteria and nitrates even outside of a sale, so a pre-listing panel is doing double duty. If your well hasn't been tested in the last year, [request a free estimate here](/#contact) and get ahead of it before you're negotiating from behind.
...
A buyer orders a well inspection to find out what's true about the property right now, independent of what the seller says. We cover that whole process, flow testing, pump and pressure system checks, water quality panels, in our guide to [well inspection when buying a house](/blog/well-inspection-buying-home/). That inspection exists specifically because Form 17 only requires the seller's actual knowledge, not a technical evaluation.

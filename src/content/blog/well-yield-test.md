---
title: "Well Yield Testing: How GPM Flow Tests Work and What's Normal"
navTitle: "Well Yield Testing: How GPM"
metaTitle: "Well Yield Test: How GPM Flow Testing Works & Normal Numbers"
metaDescription: "What does a well yield test measure, and what GPM is normal? A Wenatchee well pro explains flow testing step by step, real costs, and what to do if you test low."
primaryKeyword: "well yield test"
secondaryKeywords: "well flow test, GPM well test, well yield testing cost, normal well GPM, low yield well"
publishedDate: "2026-07-14"
tag: "Water Quality"
subtitle: "Two wells on the same road outside Cashmere. One pumps 25 gallons a minute all day long. The other struggles to make 3."
canonical: "https://wenatcheewellpros.com/blog/well-yield-test/"
faq:
  - question: "How many GPM should a residential well produce?"
    answer: "Most lenders and health authorities look for 3 to 5 GPM sustained as the minimum for a single-family home. That said, wells producing 1 to 3 GPM can serve a household comfortably with a storage tank and booster pump. What matters is sustained yield plus storage, not the first-minute flow rate."
  - question: "How long does a well yield test take?"
    answer: "A standard flow test takes 1 to 2 hours on site, including setup, the sustained pumping period, and recovery measurement. Extended drawdown tests for new wells or irrigation planning run 4 to 24 hours. You'll usually have a written report within a day or two."
  - question: "Can a well yield test hurt my well or pump?"
    answer: "No, when it's done correctly. A proper test monitors the water level the entire time and throttles or stops before the level reaches the pump intake. Running a well dry is exactly what we're testing to prevent, so a careful tester never lets it happen during the test itself."
  - question: "Does well yield change with the seasons?"
    answer: "Yes, especially in fractured-rock wells around Cashmere, Leavenworth, and Chelan. Static water levels are typically highest after spring snowmelt and lowest in late summer and early fall. That's why August and September tests give the most conservative, and most useful, picture of what your well can really do."
---
...
One thing a yield test does not measure is water quality. Bacteria, nitrates, and arsenic need lab work, which we cover in our guide to [well water testing in the Wenatchee area](/blog/well-water-testing-wenatchee/). Yield and quality are separate questions, and you usually want answers to both, especially during a home purchase.

If you're not sure what your well produces, or it's been more than five years since anyone checked, [request a free estimate on a flow test](/#contact) and we'll give you a straight answer with real numbers.
...
1. **Record the static water level.** Before anything runs, we drop a sounder down the casing and measure where the water sits. Say it's at 40 feet in a 200-foot well.
2. **Open a hose bib or test port and run the well hard.** We bypass the pressure tank when possible so we're measuring the well, not the tank.
3. **Measure flow with a calibrated meter or timed bucket.** A 5-gallon bucket that fills in 30 seconds means 10 GPM. Simple, but it works.
4. **Run continuously for at least 60 minutes.** The first 15 minutes mostly drain water stored in the casing. The real yield shows up after that, once the well has to keep up on its own.
5. **Track drawdown during the test.** If the water level drops from 40 feet to 90 feet and stabilizes, that's useful data. If it keeps falling toward the pump, the well can't sustain that flow.
6. **Shut down and time the recovery.** A healthy well typically recovers most of its drawdown within an hour or two.
...
Most lenders and health departments consider **3 to 5 GPM sustained** the minimum for a single-family home. The Washington State Department of Health uses similar adequacy guidance for small water systems ([doh.wa.gov](https://doh.wa.gov/community-and-environment/drinking-water)). Below 3 GPM, a household can still function, but it usually needs storage to buffer peak demand.

A typical family of four uses 200 to 400 gallons a day. Spread over 24 hours, that's well under 1 GPM. The problem is nobody uses water evenly. Two showers, a dishwasher, and a sprinkler zone running at 6 p.m. can demand 12 to 15 GPM all at once. That's where yield, storage, and [proper pump sizing](/blog/well-pump-sizing/) all have to work together.
...
- **Quincy and Moses Lake basin:** basalt aquifer wells often run 15 to 50+ GPM, though some zones in the Columbia Basin have declining water levels, a trend the USGS has documented in regional groundwater studies ([usgs.gov](https://www.usgs.gov/special-topics/water-science-school/science/aquifers-and-groundwater)).

Depth doesn't equal yield, by the way. We've tested 500-foot wells making 2 GPM and 120-foot wells making 30. If you're curious how depth plays into it locally, see [how deep wells go around Wenatchee](/blog/how-deep-are-wells-wenatchee/).
...
One caveat for rural buyers: under Washington's permit-exempt well rules, what you can legally use isn't always what the well can physically produce. Our post on [permit-exempt wells in Washington](/blog/permit-exempt-wells-washington/) explains the limits by county.
...
Compare that to the cost of getting it wrong. A storage tank and booster system runs $3,000 to $7,000. Hydrofracturing a tight well runs $3,000 to $6,000. Drilling a new well in this region can pass $30,000, and we break that down in our guide to [well drilling costs in Washington](/blog/well-drilling-cost-washington/). A $350 test that informs a $30,000 decision is the best money in the well business.
...
Want to know what your well is really making? [Call (509) 300-5151](tel:+15093005151) and we'll schedule a test, usually within a few days, same week in most of Chelan and Douglas counties.
...
Sometimes the well is fine and the equipment is lying to you. A worn pump, a clogged intake screen, a failing check valve, or a [waterlogged pressure tank](/blog/pressure-tank-waterlogged/) can all mimic a low-yield well. This is why we test at the wellhead, not at the kitchen faucet. If the well makes 12 GPM but the house only sees 4, the problem is between the two, and [well pump repair](/well-pump-repair-wenatchee/) is usually far cheaper than any of the options below.
...
- **Buying or selling a rural property.** Non-negotiable. Most lenders require it, and every buyer should. Pair it with a full [well inspection before buying a home](/blog/well-inspection-buying-home/).
...
- **Before replacing a pump.** Yield determines correct pump size. An oversized pump on a low well will pump it dry and burn itself out, a mistake we see constantly on [well pump replacement](/well-pump-replacement-wenatchee/) calls.
...
Ready to put a real number on your well? [Schedule your flow test here](/#contact) or call us at (509) 300-5151. Free estimates, licensed and insured in Washington, and we'll explain every number on the report in plain English.

---
title: "Shared Well Agreement Washington: Rights, Costs, and Pitfalls to Avoid"
navTitle: "Shared Well Agreement"
metaTitle: "Shared Well Agreement Washington: Rights & Pitfalls"
metaDescription: "A shared well agreement in Washington protects your water and your wallet. Learn what to include, who pays for repairs, and the pitfalls that sink deals."
primaryKeyword: "shared well agreement washington"
secondaryKeywords: "shared well agreement, shared well laws washington state, shared well rights, well sharing agreement, shared well problems"
publishedDate: "2026-06-24"
tag: "Cost Guide"
subtitle: "Two neighbors. One well. A $4,200 pump bill. Guess how that conversation goes when nothing is in writing."
canonical: "https://wenatcheewellpros.com/blog/shared-wells-washington/"
faq:
  - question: "Is a shared well agreement legally required in Washington?"
    answer: "No state law forces neighbors to sign one for an existing two-party well. But lenders frequently require a recorded agreement before they'll finance a home on a shared well, and FHA and VA loans almost always do. Practically speaking, you need one even though the state doesn't mandate it."
  - question: "How many homes can share one well in Washington?"
    answer: "The permit-exempt limit is 5,000 gallons per day per well for group domestic use, with lower caps in some basins, so the legal answer depends on usage rather than a fixed house count. The practical answer depends on the well's yield, often a bigger constraint than the law. Serve enough connections and you may also be regulated as a Group B public water system, so check with your county health district before adding homes."
  - question: "Who pays when a shared well pump fails?"
    answer: "Whatever the recorded agreement says, which is exactly why you want one. Most agreements split repair and replacement costs equally among the connected homes or in proportion to use. Without an agreement, the owner of the parcel where the well sits often ends up paying just to restore their own water, then chasing neighbors for reimbursement."
  - question: "Can my neighbor cut off my water from a shared well?"
    answer: "If you have a recorded agreement and easement, no. Your right to the water runs with the land and a court will enforce it. If everything is verbal, you're in murky territory, and that's the single best argument for getting an agreement drafted and recorded now, while everyone's still friendly."
---
...
Second, some Washington basins now have tighter limits on new permit-exempt wells under the 2018 streamflow restoration law, with daily caps well below 5,000 gallons in certain watersheds. If you're drilling new or adding a connection, check the rules for your specific basin through the [Washington Department of Ecology](https://ecology.wa.gov/water-shorelines/water-supply/wells) before you spend a dime. We cover the exemption in more detail in our guide to [permit-exempt wells in Washington](/blog/permit-exempt-wells-washington/).

Third, hook enough homes to one well and you stop being a private well at all. In Washington, a system serving multiple connections can be classified as a Group B public water system under [Department of Health rules](https://doh.wa.gov/community-and-environment/drinking-water), which brings design approval, water quality testing, and paperwork. The Chelan-Douglas Health District and Grant County Health District both handle these locally, and their thresholds and processes differ. If your shared well serves three or more homes, make the call before you add a fourth.
...
If you want a professional read on the physical system before you sign anything, [request a free shared well assessment here](/#contact). We'll document pump age, tank condition, flow rate, and wiring so the agreement reflects reality instead of guesswork.
...
| Expense | Typical Cost | Per Home (2-way split) | Per Home (3-way split) |
|---|---|---|---|
...
2. **A well inspection.** Pump age, flow rate, pressure tank condition, casing and cap condition, wiring. Our guide to [well inspections when buying a home](/blog/well-inspection-buying-home/) walks through the full checklist.
...
One more thing on the mechanical side. Shared systems work harder than single-home systems. The pump cycles more, the pressure tank takes more abuse, and small problems hit multiple families at once. If your shared pump is short cycling, losing pressure, or tripping the breaker, don't wait for the group text to turn ugly. Our [well pump repair team in Wenatchee](/well-pump-repair-wenatchee/) handles shared systems all over Chelan, Douglas, and Grant counties, and we're available 24/7 when the water stops. [Reach out for a free estimate](/#contact) or call (509) 300-5151.
